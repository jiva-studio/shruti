...
This skill orchestrates the **Specification-Driven Development (SDD)** workflow in lectorium. Before writing code, `/spec` transforms requirements into a structured, persistent, and verifiable specification file located at `.agents/specs/<branch-slug>.md`.

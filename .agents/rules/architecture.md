...
The architecture of shruti is written down in [`docs/repos/shruti/`](../../docs/repos/shruti/README.md), and the mobile app's layering in [`architecture/layers.md`](../../docs/repos/shruti/architecture/layers.md). This file is the map: it says where things live and which way the arrows point. When it and a document there disagree, the document wins, and this file is the thing to fix.
...
├── docs/repos/shruti/         # the architecture, the runbooks, the API and DB reference
├── tests/

...
export interface FailedEvent {
   ...
   *
   * The code lets a caller tell a deliberate local abort from a genuine
   * error: neither is worth a retry affordance, and neither should be
   * retried against another server.
   *

...
vi.mock("@lectorium/composables/useShareAudioArtifact.js", () => ({
  useShareAudioArtifact: () => vi.fn(async () => ({ ok: false, reason: "no_audio" })),
}))
vi.mock("@lectorium/composables/shareCover.js", () => ({
...
vi.mock("@lectorium/stores/useOverlaysStore.js", () => ({
...
vi.mock("@lectorium/stores/useTrackSheetStore.js", () => ({

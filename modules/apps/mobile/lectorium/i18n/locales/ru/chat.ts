export default {
  ...
  // Label вместо chip'ов пока сервер генерирует вопросы для фокусного
  // фрагмента ("Ask Sadhu"). Остаётся видимым, пока /questions не
  // отдаст ответ (или не упадёт).
  suggestionsLoading: "Подбираем вопросы…",

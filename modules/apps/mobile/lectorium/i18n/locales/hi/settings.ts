export default {
  ...
  dailyWisdom: {
    title: "दैनिक ज्ञान",
    subtitleOn: "चालू · {count} विषय",
    subtitleOff: "बंद · केवल अनुस्मारक",
    hint: "उन विषयों को चुनें जिन पर आप रोज़ एक छोटा विचार चाहते हैं — अनुस्मारक समय पर हम आपके चैट में एक चलाने योग्य अंश भेजेंगे। कुछ न चुनने पर केवल अनुस्मारक मिलेगा।",
    empty: "अभी दैनिक ज्ञान वाले कोई विषय नहीं हैं।",
  },

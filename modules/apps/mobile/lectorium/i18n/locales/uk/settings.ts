  ...
  subscription: {
    ...
    benefits: {
      ...
      benefit1: {
        title: "Закладки",
        description:
          "Зберігайте важливі моменти з тексту та аудіо лекцій, щоб повернутися до них пізніше чи поділитися з друзями.",
      },
      benefit2: {
        title: "Розумна бібліотека",
        description:
          "Застосунок сам тримає свіжі лекції на пристрої й автоматично прибирає прослухані.",
      },
      benefit3: {
      ...
      sakha: {
        title: "Сакха — ШІ-помічник",
        description:
          "Шукає в лекціях, аудіо та книгах, знаходить шлоки, генерує PDF і допомагає розібратися в матеріалі. З підпискою — більший денний ліміт.",
      },
      autoScroll: {
        title: "Автопрокрутка",
        description:
          "Транскрипт слідує за аудіо — поточний абзац завжди перед очима, гортати вручну не потрібно.",
      },
      continuousPlayback: {

...
export default {
  ...
  library: {
    ...
    failed: "Претрага библиотеке тренутно није успела. Покушајте поново.",
  ...
  collections: {
    ...
    all: "Све колекције",
    partOf: "Предавање {position} од {total}",
    seeAll: "Прикажи све",
    seeAllNamed: "Прикажи све: {name}",
    missingTitle: "Колекција није доступна",
    missingMessage:
      "Ова колекција није објављена на језику твоје библиотеке. Пробај други језик садржаја у подешавањима.",
    loadFailed: "Није могуће учитати колекцију. Покушај поново касније.",
  },
}

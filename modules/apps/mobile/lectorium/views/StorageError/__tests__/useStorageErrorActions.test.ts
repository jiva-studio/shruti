...
const app = vi.hoisted(() => ({ value: null as unknown as Lectorium }))
...
vi.mock("@lectorium/lectorium.js", () => ({ useLectorium: () => app.value }))

import { useStorageErrorActions } from "../useStorageErrorActions.js"

function makeApp(deleteDatabase: () => Promise<void>): Lectorium {
  return {

...
vi.mock("@lectorium/views/components/TrackRowsList.vue", () => ({
...
vi.mock("@lectorium/services/regionsRegistry.js", () => ({ resolveAssetUrl: (k: string) => k }))
...
vi.mock("@lectorium/composables/useTrackActionSheet.js", () => ({

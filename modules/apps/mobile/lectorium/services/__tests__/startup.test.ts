...
vi.mock("@lectorium/services/bootstrap.js", () => ({ bootstrapUserDatabaseOrClose: vi.fn() }))
vi.mock("@lectorium/services/contentDatabase.js", () => ({ sweepCatalogCopyTemps: ctx.sweep }))
...
vi.mock("@lectorium/services/storageHealth.js", () => ({
  recordStorageFailure: ctx.recordStorageFailure,
}))

import { createLectoriumBootstrap, runStartupBootstrap } from "../startup.js"

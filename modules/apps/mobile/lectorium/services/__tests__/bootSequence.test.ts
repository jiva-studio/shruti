...
vi.mock("@lectorium/i18n/index.js", () => ({ bootLocaleReady: Promise.resolve() }))
...
vi.mock("@lectorium/lectorium.js", () => ({
  useLectorium: () => ({ setActiveServerById: ctx.setActiveServerById }),
}))
vi.mock("@lectorium/services/regionsRegistry.js", () => ({
  hydrateRegions: ctx.hydrateRegions,
  findRegion: ctx.findRegion,
}))
vi.mock("@lectorium/services/preferredServer.js", () => ({
  readPreferredServerId: ctx.readPreferredServerId,
}))
vi.mock("@lectorium/services/startup.js", () => ({
  runStartupBootstrap: ctx.runStartupBootstrap,
}))
vi.mock("@lectorium/services/regionWatch.js", () => ({ startRegionWatch: ctx.startRegionWatch }))
vi.mock("@lectorium/services/startupRoute.js", () => ({
  resolveInitialRoute: ctx.resolveInitialRoute,
}))
vi.mock("@lectorium/services/postMount.js", () => ({ runPostMountWork: ctx.runPostMountWork }))
vi.mock("@lectorium/services/monitoring/reportError.js", () => ({ reportError: ctx.reportError }))

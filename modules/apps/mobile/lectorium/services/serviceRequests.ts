...
} from "@lectorium/services/regionFailover.js"
import { withNetworkErrorContext } from "@lectorium/services/http/networkError.js"
import { createUnauthorizedRetry } from "@lectorium/services/http/unauthorizedRetry.js"
import { isChatStreamPath, withRequestTimeout } from "@lectorium/services/http/requestTimeout.js"
...
export function createServiceRequests() {
  ...
  // initLectorium). `getServers` is read per request, so a region list

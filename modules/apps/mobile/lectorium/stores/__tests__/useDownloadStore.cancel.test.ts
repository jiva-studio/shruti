...
vi.mock("@lectorium/stores/useDownloadQuotaStore.js", () => ({
  useDownloadQuotaStore: () => quota,
}))
vi.mock("@lectorium/stores/downloads/useServerFallback.js", () => ({
  useServerFallback: () => ({ candidates: () => [SERVER] }),
}))
vi.mock("@lectorium/stores/downloads/useTranscriptPrefetch.js", () => ({

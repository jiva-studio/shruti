...
import { createPurchasesBootstrap } from "@lectorium/stores/purchases/bootstrap.js"
import { createEntitlementState } from "@lectorium/stores/purchases/entitlementState.js"
import { watchRcIdentity } from "@lectorium/stores/purchases/identityWatch.js"
import { ensureProAccess } from "@lectorium/stores/purchases/proGate.js"
import { tierDisagrees, type RcIdentityDeps } from "@lectorium/stores/purchases/rcIdentity.js"
import {
  createReconcileTracker,
  RECONCILE_BUDGET_MS,
} from "@lectorium/stores/purchases/reconcile.js"
import {
...
export const usePurchasesStore = defineStore("purchases", () => {
  ...
  function rcDeps(): RcIdentityDeps {
    ...
    return {
      purchases: useLectorium().purchases,
  ...
  async function logOut(): Promise<void> {
    ...
    try {
      entitlement.apply(await useLectorium().purchases.logOut())
    } catch (e) {

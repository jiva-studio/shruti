...
import { wipeLocalUserData, type WipeLocalUserDataOptions } from "@shruti/services/dataWipe.js"
 ...
 */
export async function releaseDevice(app: Shruti, opts: ReleaseDeviceOptions): Promise<void> {
  if (opts.wipeLocal) {
    try {

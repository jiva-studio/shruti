...
let builds = 0
vi.mock("@shruti/composables/buildTrackRow.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@shruti/composables/buildTrackRow.js")>()
  return {
...
vi.mock("@shruti/stores/useDownloadStore.js", () => ({ useDownloadStore: () => downloads }))

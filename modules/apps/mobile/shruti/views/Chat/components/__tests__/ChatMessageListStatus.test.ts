...
vi.mock("@shruti/stores/useChatStore.js", () => ({ useChatStore: () => state.chat }))
vi.mock("@shruti/stores/useAuthStore.js", () => ({ useAuthStore: () => state.auth }))
vi.mock("@shruti/stores/usePaywallStore.js", () => ({
  usePaywallStore: () => ({ requestOpen: state.requestOpen }),
}))
vi.mock("@shruti/composables/useAnonymousSignInFlow.js", () => ({

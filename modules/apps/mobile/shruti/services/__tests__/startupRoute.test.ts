...
const USER_DB_PATH = "databases/shruti/user.db"
const CONTENT_DB_PATH = "databases/shruti/content.db"
...
function initWithFailingUserDb(preferences: IPreferences): Shruti {

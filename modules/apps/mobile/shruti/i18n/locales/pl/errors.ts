export default {
  ...
  downloadNotSaved: "Wykład został pobrany, ale nie udało się go zapisać na urządzeniu. Zwolnij miejsce i spróbuj ponownie.",
  ...
  downloadsCacheUnavailable:
    "Nie udało się odczytać listy pobrań. Pobrane pliki nadal są na dysku.",

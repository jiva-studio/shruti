export default {
  ...
  error: {
    protocolMismatch: {
      ...
      body: "La chat usa un nuovo protocollo. Aggiorna Shruti per continuare.",
      cta: "Apri store",
    },
  ...
  errTruncatedError: " (interrotto — la risposta non è stata completata)",
  ...
  actionNoteError: "Impossibile salvare la nota.",

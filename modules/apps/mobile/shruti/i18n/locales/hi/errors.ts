export default {
  ...
  downloadNotSaved: "प्रवचन डाउनलोड हो गया, लेकिन डिवाइस पर सहेजा नहीं जा सका। कुछ जगह खाली करके फिर कोशिश करें।",
  downloadNoSource: "इस प्रवचन के लिए डाउनलोड करने योग्य कोई फ़ाइल नहीं है।",
  downloadAlreadyRunning: "यह प्रवचन पहले से डाउनलोड हो रहा है।",
  downloadFailedUnknown: "डाउनलोड नहीं हो सका। फिर कोशिश करें।",

export default {
  ...
  library: {
    ...
    mine: "निजी लाइब्रेरी",
    failed: "अभी लाइब्रेरी में खोज नहीं हो सकी। फिर से कोशिश करें।",
  ...
  collections: {
    ...
    missingTitle: "संग्रह उपलब्ध नहीं है",
    missingMessage:
      "यह संग्रह आपकी लाइब्रेरी की भाषा में प्रकाशित नहीं है। सेटिंग्स में कोई दूसरी सामग्री भाषा आज़माएँ।",
    loadFailed: "संग्रह लोड नहीं हो सका। कृपया बाद में पुनः प्रयास करें।",
  },
}

export default {
  title: "Studio",
  hint: "Vous pouvez retoucher la citation avant de générer la vidéo.",
  placeholder: "Texte de la citation",
  titleLabel: "Titre",
  titlePlaceholder: "Titre facultatif",
  download: "Télécharger",
  preparing: "Préparation…",
  rendering: "Création de la vidéo…",
  almostReady: "Presque prêt…",
  stillWorking: "Encore un instant…",
  downloading: "Téléchargement…",
  shareDialog: "Partager la vidéo",

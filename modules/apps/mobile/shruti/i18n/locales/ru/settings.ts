export default {
  ...
  autoDownload: {
    ...
    description: "Поддерживать запас непрослушанных лекций на устройстве",
    enable: "Включить",
    hint: "Приложение поддерживает запас непрослушанных лекций выбранной длительности. Какие именно лекции попадают в очередь — задаёт фильтр ниже.",
    sections: {
      filter: "Что качать",
  ...
  autoArchive: {
    title: "Автоархивация прослушанных",
    description: "Убирать прослушанные лекции из плейлиста через выбранный срок",
    delay: {
      off: "Выключено",
      immediate: "Сразу",
      _8h: "Через 8 часов",

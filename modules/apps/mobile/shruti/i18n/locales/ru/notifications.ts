export default {
  ...
  // Показывается, когда ответ в чате готов, а приложение в фоне, или
  // предиктивно (запланировано при отправке), если приложение заморозилось.
  // Нейтральный текст — при предиктивном планировании исход ещё неизвестен.
  chatAnswerReadyTitle: "Sadhu ответил",
  chatAnswerReadyBody: "Ваш ответ готов — нажмите, чтобы прочитать.",

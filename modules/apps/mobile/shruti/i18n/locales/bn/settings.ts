export default {
  ...
  dailyWisdom: {
    title: "দৈনিক প্রজ্ঞা",
    subtitleOn: "চালু · {count}টি বিষয়",
    subtitleOff: "বন্ধ · শুধু অনুস্মারক",
    hint: "যে বিষয়গুলোতে প্রতিদিন একটি ছোট ভাবনা পেতে চান সেগুলো বেছে নিন — অনুস্মারকের সময়ে আমরা আপনার চ্যাটে একটি চালানোর যোগ্য অংশ পাঠাব। কিছু নির্বাচন না করলে শুধু অনুস্মারক আসবে।",
    empty: "এখনও দৈনিক প্রজ্ঞাসম্পন্ন কোনো বিষয় নেই।",
  },

  ...
  subscription: {
    ...
    benefits: {
      ...
      benefit3: {
        ...
        description:
          "সুবিধাজনক ক্রমে শুনতে আপনার প্লেলিস্টে সেমিনার ও কোর্স যোগ করুন।",
      },
      benefit4: {
      ...
      notesStudio: {
        title: "নোটস স্টুডিও",
        description: "লেকচার থেকে আপনার নোটগুলোকে ছোট ভিডিওতে পরিণত করুন এবং বন্ধুদের সাথে শেয়ার করুন।",
      },
      trackInfo: {

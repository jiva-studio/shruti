export default {
  ...
  error: {
    protocolMismatch: {
      ...
      body: "Der Chat nutzt ein neues Protokoll. Aktualisiere Shruti, um fortzufahren.",
      cta: "Store öffnen",
    },
  ...
  errTruncatedError: " (abgebrochen — die Antwort konnte nicht fertiggestellt werden)",

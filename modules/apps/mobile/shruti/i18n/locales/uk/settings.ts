export default {
  ...
  dailyWisdom: {
    ...
    subtitleOn: "Увімк. · тем: {count}",
    subtitleOff: "Вимк. · лише нагадування",
    hint: "Обери теми, за якими хочеш отримувати коротку думку дня — ми надішлемо відтворюваний фрагмент у чат під час нагадування. Якщо нічого не обрано, прийде лише нагадування.",
    empty: "Поки немає тем зі щоденною мудрістю.",
  },

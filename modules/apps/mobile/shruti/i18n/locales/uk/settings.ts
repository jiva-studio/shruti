export default {
  ...
  account: {
    ...
    signOut: "Вийти",
    signOutWipeToast:
      "Ви вийшли. Нотатки та листування зберігаються в акаунті й повернуться після наступного входу. Завантажені лекції видалено з цього пристрою — їх потрібно буде завантажити знову.",
    signOutWipeToastChatLocal:
      "Ви вийшли. Нотатки зберігаються в акаунті й повернуться після наступного входу. Синхронізацію листування було вимкнено, тож воно було лише на цьому пристрої та його видалено. Завантажені лекції теж видалено — їх потрібно буде завантажити знову.",
    signOutWipeUnsentSuffix: "Останні зміни не вдалося вивантажити перед виходом, і їх втрачено.",
    deleteAccount: {
  ...
  subscription: {
    ...
    unconfirmed:
      "Не вдалося підтвердити статус підписки. Якщо вона в вас уже є, натисніть «Відновити».",

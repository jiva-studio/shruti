...
export default {
  ...
  subscription: {
    ...
    noSubscriptionFound:
      "Активна претплата није пронађена. Претплатите се да бисте приступили Про функцијама.",
    cantPay: "Не могу да платим",
    cantPayEmailSubject: "Не могу да платим",
    cantPayEmailIntro: "Не могу да платим.",
    thanks:
    ...
    benefits: {
      ...
      benefit0: {
        ...
        description: "Ваша претплата нам помаже да наставимо додавање нових предавања.",
      },
      benefit1: {
        title: "Обележивачи",
        description:
          "Сачувајте важне тренутке из текста и аудија предавања да им се касније вратите или их поделите са пријатељима.",
      },
      benefit2: {
        title: "Паметна библиотека",
        description:
          "Апликација сама држи свежа предавања на уређају и аутоматски уклања одслушана.",
      },
      benefit3: {
      ...
      sakha: {
        title: "Питај Садхуа",
        description:
          "Претражује предавања, аудио и књиге, проналази шлоке, генерише PDF-ове и помаже вам да разумете учења. Већи дневни лимит долази уз претплату.",
      },
      autoScroll: {
        title: "Аутоматско скроловање",
        description: "Транскрипт прати репродукцију аудија, па је тренутни пасус увек пред очима.",
      },
      continuousPlayback: {
  ...
  dailyWisdom: {
    ...
    subtitleOn: "Укљ. · {count} тема",
    subtitleOff: "Искљ. · само подсетник",
    hint: "Изабери теме о којима желиш кратку дневну мисао — послаћемо фрагмент који се може пустити у твој чет у време подсетника. Без избора, добићеш само подсетник.",
    empty: "Још нема тема са дневном мудрошћу.",
  },

...
export default {
  ...
  error: {
    protocolMismatch: {
      ...
      body: "Ћаскање користи нови протокол. Ажурирајте Shruti да бисте наставили.",
  ...
  actionUpgradeToProBody:
    "Откључајте Паметну библиотеку, Студио за белешке и остатак Pro пакета да извучете највише из апликације.",
  actionUpgradeToProConfirm: "Погледај Pro",

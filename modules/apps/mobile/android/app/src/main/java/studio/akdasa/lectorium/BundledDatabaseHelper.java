 ...
 * Target location: getFilesDir()/lectorium/databases/*.db
 *
...
public class BundledDatabaseHelper {
    ...
    private static final String TARGET_SUBDIR = "lectorium/databases";
     ...
     * {@code getFilesDir()/lectorium/databases/}, unless the device already
    ...
    /** {@code "lectorium.42.db"} → {@code "lectorium"}; the name itself when unversioned. */

...
// IonDatetime's event detail type is loose (`value?: string | string[] | null`),
// so we receive it as the generic CustomEvent and narrow manually.
function onChange(e: Event) {
  const detail = (e as CustomEvent<{ value?: string | string[] | null }>).detail

...
import { parseChatMarkers, type ChatToken } from '@lectorium/composables/chatMarkers/parse.js'
import VerseCard from '@lectorium/views/Chat/components/VerseCard.vue'
import ChapterCard from '@lectorium/views/Chat/components/ChapterCard.vue'
import CitationCard from '@lectorium/views/Chat/components/CitationCard.vue'
import CommentaryCard from '@lectorium/views/Chat/components/CommentaryCard.vue'
import MediaCard from '@lectorium/views/Chat/components/MediaCard.vue'
import NotesInlinePlayer from '@lectorium/views/Notes/NotesInlinePlayer.vue'
import OutlineCard from '@lectorium/views/Chat/components/OutlineCard.vue'
      ...
      >
        <template v-if="citeBody(tk)" #player>
          <NotesInlinePlayer
            ...
            :cut="webCut"
            :predict-url="(id) => 'https://akds-lectorium.s3.us-east-1.amazonaws.com/public/shares/audio/' + id + '.mp3'"
          >
            <template #spinner><span class="dots-spinner" /></template>
          </NotesInlinePlayer>
        </template>

...
export const russianTranslations: TranslationMap = {
  // App name
  'app.name': 'Слушай Садху',
  // App description
  'app.description': 'Слушай мудрость вед и духовные наставления садху, изучая Бхагавад-гиту, Шримад Бхагаватам и другие священные тексты в одном простом приложении.',
  // Hero section
  ...
  // Feature section
  'features.title': 'Вечная мудрость для современных искателей',
  ...
  'download.description': 'Загрузите приложение Shruti сегодня и получите доступ к вековой ведической мудрости, переосмысленной для вашего современного жизненного пути.',

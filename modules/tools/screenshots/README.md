# Shruti screenshots pipeline

Playwright-driven pipeline that captures store screenshots of the Shruti mobile app and composites them into Google Play / App Store device frames.
...
debug bridge at `modules/apps/mobile/shruti/services/debug/` is

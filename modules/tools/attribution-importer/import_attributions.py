...
See README.md for the full design. Quick summary:
  ...
  Drives: shruti-mcp daemon at http://127.0.0.1:8081/mcp (JSON-RPC)
...
class MCPClient:
    ...
    shruti-mcp serves MCP at /mcp accepting POSTs with JSON-RPC bodies.
...
def main() -> int:
    ...
    parser.add_argument("--mcp-url", default="http://127.0.0.1:8081/mcp",
                        help="shruti-mcp endpoint (default: http://127.0.0.1:8081/mcp)")

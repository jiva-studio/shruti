// Lectorium publish-service — the PROMOTION side of the personal-library
...
import (
	...
	logpkg "github.com/jiva-studio/lectorium/publish/internal/logging"
	"github.com/jiva-studio/lectorium/publish/internal/store"
	"github.com/jiva-studio/lectorium/publish/internal/wire"
)
...
func runMigrate() int {
	...
	logpkg.Setup("lectorium-publish", cfg.Env, cfg.ServiceVersion)

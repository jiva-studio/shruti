// Package logx sets up slog with a pino-compatible JSON shape so existing
// Datadog dashboards keep working after the cutover from structlog.
//
...
func replaceAttr(_ []string, a slog.Attr) slog.Attr {
	...
	case slog.TimeKey:
		...
		// so a single Datadog parser handles both this and the legacy pino
		// share-video output.

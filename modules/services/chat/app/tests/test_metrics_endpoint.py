...
import shruti_chat.observability.metrics  # noqa: F401
...
def test_metrics_registry_exposes_chat_counters() -> None:
    ...
    assert "shruti_chat_rate_limit_hits_total" in body
    assert "shruti_chat_rate_limit_redis_unavailable_total" in body

...
from lectorium_chat.domain.source_ids import chunk_source_filter, is_opaque_source_id
...
async def test_the_planners_second_stage_follows_the_same_rule() -> None:
    from lectorium_chat.research.thesis_augmentation import _fresh_fanout_for_thesis

...
from shruti_chat.config import Settings  # noqa: E402
from shruti_chat.domain.ports.llm_provider import ProviderUnavailable  # noqa: E402
from shruti_chat.observability.logging import setup_logging  # noqa: E402
from shruti_chat.observability.sentry import init_sentry  # noqa: E402
...
def _log_exception(event: str, exc: BaseException, **fields: Any) -> None:
    ...
    log = structlog.get_logger("shruti_chat.tests.sentry")
    try:
        raising_frame()

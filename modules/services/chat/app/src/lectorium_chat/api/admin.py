...
from lectorium_chat.observability.metrics import prompt_source_summary
...
_BUILD_SHA = get_settings().lectorium_build_sha
_BUILD_TIME = get_settings().lectorium_build_time
...
async def version() -> dict[str, Any]:
    s = get_settings()
    return {"git_sha": s.service_version, "service": "lectorium-chat"}

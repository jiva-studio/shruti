#!/usr/bin/env python3
"""Smoke-test the chunker on a real Lectorium transcript.
...
from lectorium_chat.indexer.chunker import chunk_reviewed  # noqa: E402


def main() -> None:
    raw = Path(
        "/home/akd/Projects/akdasa-studios/lectorium/resources/lake-out/"

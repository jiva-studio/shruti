...
const BUCKET = process.env.LECTORIUM_S3_BUCKET || process.env.BUCKET || '';
const BACKGROUNDS_PREFIX = process.env.LECTORIUM_S3_BACKGROUNDS_PREFIX || 'private/share/video/backgrounds';
const OUTPUT_PREFIX = process.env.LECTORIUM_S3_VIDEO_PREFIX || 'public/share/video';

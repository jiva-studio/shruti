...
def track_process():
    ...
    # database_collections: ShrutiDatabaseCollections = (
    ...
    # ):
    #     database_connection_string = Variable.get(SHRUTI_DATABASE_CONNECTION_STRING)
    #     database_collections = Variable.get(SHRUTI_DATABASE_COLLECTIONS, deserialize_json=True)
    ...
    #     track_document = shruti.tracks.prepare_track_document(
    #         track_id=track_id,
    ...
    #     shruti.shared.actions.set_dag_run_note(
    #         dag_run=dag_run,
    #         note=(
    #             f"## `{track_inbox["_id"]}`\n\n"

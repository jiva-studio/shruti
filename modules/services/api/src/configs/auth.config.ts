...
export default registerAs('auth', () => ({
  ...
  savePermissionsInJwtToken:
    process.env.SHRUTI_AUTH_SAVE_PERMISSIONS_IN_JWT_TOKEN === 'true',
   ...
   */
  googleOAuthClientId: process.env.SHRUTI_AUTH_GOOGLE_OAUTH_CLIENT_ID || '',

  /**
   * User id generation salt.
   */
  userIdGenerationSalt:
    process.env.SHRUTI_AUTH_USER_ID_GENERATION_SALT || '',
}));

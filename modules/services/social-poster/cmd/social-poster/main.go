// Lectorium social-poster. A single service that, on a schedule, selects
...
import (
	...
	"github.com/jiva-studio/lectorium-social-poster/internal/httpx"
	...
	"github.com/jiva-studio/lectorium-social-poster/internal/scheduler"
...
func runService() int {
	bootLog := logx.New("info", "lectorium-social-poster", "dev", "dev")
	...
	log := logx.New(cfg.Service.LogLevel, "lectorium-social-poster", cfg.Service.Env, cfg.Service.ServiceVersion)

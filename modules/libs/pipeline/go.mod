// Package module github.com/jiva-studio/lectorium/pipeline holds the pure,
// reusable transcribe/review/normalize pipeline pieces extracted from the
// lectorium-mcp tool so future services (e.g. an orchestrator) can import
...
module github.com/jiva-studio/lectorium/pipeline

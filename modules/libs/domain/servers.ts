 ...
 * `global` now resolves to Bunny CDN (`akds-lectorium.b-cdn.net`), the
...
/**
 * Lectorium's region descriptor. Extends kit's generic `CdnServer`
...
export interface CdnServer extends KitCdnServer {
  ...
  /** Base URL of the lectorium `profile` device↔server sync service for
...
export const SERVERS: readonly CdnServer[] = [
  {
    id: "global",
    name: "Global",
    urlTemplate: "https://akds-lectorium.b-cdn.net/{path}",

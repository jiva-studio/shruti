...
#    https://grafana.obs.eu.shruti.akdasa.studio
#    https://langfuse.obs.eu.shruti.akdasa.studio
#    https://prometheus.obs.eu.shruti.akdasa.studio
```
...
REGION=ru
TAILNET_DOMAIN=obs.ru.shruti.akdasa.studio
OBS_TS_IP=100.x.x.X

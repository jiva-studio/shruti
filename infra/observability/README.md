...
#    https://grafana.obs.eu.shruti.jiva.studio
#    https://langfuse.obs.eu.shruti.jiva.studio
#    https://prometheus.obs.eu.shruti.jiva.studio
```
...
REGION=ru
TAILNET_DOMAIN=obs.ru.shruti.jiva.studio
OBS_TS_IP=100.x.x.X

...
`docker exec shruti-observability-clickhouse-1 …` and similar work
...
- Container names follow compose v2 naming with the project name set in
  `compose/docker-compose.yml` (`name: shruti-observability`), e.g.
  `shruti-observability-grafana-1`, `shruti-observability-clickhouse-1`.

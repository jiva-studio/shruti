...
ENV_FILE="${SHRUTI_ENV_FILE:-/opt/shruti/.env}"
PROJECT="shruti"
PG_CONTAINER="${SHRUTI_PG_CONTAINER:-${PROJECT}-postgres-1}"
...
: "${SHRUTI_S3_BUCKET:?SHRUTI_S3_BUCKET must be set in $ENV_FILE}"

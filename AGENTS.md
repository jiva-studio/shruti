...
Welcome to Shruti. All AI coding agents operating on this repository must adhere to the rules and skills defined here.

Shruti is a lecture library: Go services behind a Caddy origin, a Python
...
model — is in [`docs/repos/shruti/`](./docs/repos/shruti/README.md). The
...
`.agents/rules/` holds everything specific to Shruti — the layout, the

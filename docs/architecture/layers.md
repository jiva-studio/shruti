...
| `infra/audio/capacitor/` | `IAudioPlayer` wrapping `@shruti/plugin-audio-player` plugin |
...
| **Must NOT import** | `@ports`, `@infra`, `@lib/domain`, `@lib/application`, `@shruti/*`, cross-feature UI siblings |

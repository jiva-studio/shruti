...
ships with the Shruti mobile app and is updated from CDN. The **current**
...
([`modules/tools/shruti-mcp/internal/infra/catalog/sqlite/migrate.go`](https://github.com/akdasa-studios/shruti/blob/main/modules/tools/shruti-mcp/internal/infra/catalog/sqlite/migrate.go))
...
[`modules/db-scheme.json`](https://github.com/akdasa-studios/shruti/blob/main/modules/db-scheme.json).
...
([`catalog/sqlite/migrate.go`](https://github.com/akdasa-studios/shruti/blob/main/modules/tools/shruti-mcp/internal/infra/catalog/sqlite/migrate.go))

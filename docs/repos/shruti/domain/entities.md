...
### `DailyWisdom` — [`dailyWisdom.ts`](https://github.com/jiva-studio/shruti/blob/main/modules/libs/domain/dailyWisdom.ts)
...
### `LibraryItem` — [`libraryItem.ts`](https://github.com/jiva-studio/shruti/blob/main/modules/libs/domain/libraryItem.ts)
...
### `LibraryMembership` — [`libraryMembershipRepository.ts`](https://github.com/jiva-studio/shruti/blob/main/modules/libs/domain/ports/libraryMembershipRepository.ts)

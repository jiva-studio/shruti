...
> Code (mobile): `modules/apps/mobile/infra/chat/http/chatClient.ts`, `.../httpChatStreamClient.ts`, `.../httpChatResumeService.ts`, `modules/apps/mobile/usecases/chat/runChatTurn.ts`, `modules/apps/mobile/shruti/composables/chatMarkers/parse.ts`

...
Source: [`modules/plugins/media-downloader/`](https://github.com/jiva-studio/shruti/tree/main/modules/plugins/media-downloader). Mobile-side adapter: [`modules/apps/mobile/infra/mediaDownloader/plugin/`](https://github.com/jiva-studio/shruti/tree/main/modules/apps/mobile/infra/mediaDownloader/plugin).
...
The adapter ([`useMediaDownloaderAdapter.ts`](https://github.com/jiva-studio/shruti/blob/main/modules/apps/mobile/infra/mediaDownloader/plugin/useMediaDownloaderAdapter.ts)) bridges the plugin's task-id model to this URL-keyed port:

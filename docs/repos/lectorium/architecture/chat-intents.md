...
> Code: `modules/services/chat/app/src/lectorium_chat/agent/graph/nodes/router.py`, `application/router_turn.py`, `agent/prompts/router.md`, `domain/routing.py`, `agent/graph/conditional.py`, `agent/classify/address.py`, `research/locate.py`, `research/attribution_lookup.py`

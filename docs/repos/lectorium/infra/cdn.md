...
|---|---|---|---|
| `global` | Global | `https://akds-lectorium.s3.us-east-1.amazonaws.com/{path}` | the global origin |
| `russia` | Russia | `https://akds-lectorium.storage.yandexcloud.net/{path}` | the RU origin |

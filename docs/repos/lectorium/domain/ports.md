...
Ports are TypeScript interfaces that the domain depends on but does not implement. Use cases consume them; concrete adapters under `modules/apps/mobile/infra/repositories/` provide them; the composition root in [`lectorium.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/apps/mobile/lectorium/lectorium.ts) wires the two together. There are **16 domain ports** under [`modules/libs/domain/ports/`](https://github.com/akdasa-studios/lectorium/tree/main/modules/libs/domain/ports) — 15 repositories plus `IUnitOfWork`. The barrel [`ports/index.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/index.ts) re-exports most of them; `ITopicRepository` is imported directly from its module by the discovery use cases. A separate set of **technical ports** (see the layer doc) covers non-domain concerns like the audio player or the file system.
...
Source: [`ports/trackRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/trackRepository.ts) · Implementation: `modules/apps/mobile/infra/repositories/sql/tracksRepository.sql.ts`
...
Sources: [`authorRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/authorRepository.ts), [`locationRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/locationRepository.ts), [`sourceRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/sourceRepository.ts), [`tagRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/tagRepository.ts).
...
Source: [`languageRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/languageRepository.ts)
...
Source: [`topicRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/topicRepository.ts) · Implementation: [`topicsRepository.sql.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/apps/mobile/infra/repositories/sql/topicsRepository.sql.ts)
...
Source: [`transcriptRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/transcriptRepository.ts) · Implementation: HTTP, not SQL.
...
Source: [`noteRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/noteRepository.ts) · Implementation: [`notesRepository.sql.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/apps/mobile/infra/repositories/sql/notesRepository.sql.ts)
...
Source: [`playlistItemRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/playlistItemRepository.ts) · Implementation: [`playlistItemsRepository.sql.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/apps/mobile/infra/repositories/sql/playlistItemsRepository.sql.ts)
...
Source: [`listeningSessionRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/listeningSessionRepository.ts) · Implementation: [`listeningSessionsRepository.sql.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/apps/mobile/infra/repositories/sql/listeningSessionsRepository.sql.ts)
...
Source: [`mediaItemRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/mediaItemRepository.ts) · Implementation: [`mediaItemsRepository.sql.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/apps/mobile/infra/repositories/sql/mediaItemsRepository.sql.ts)
...
Source: [`chatSessionRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/chatSessionRepository.ts) · Implementation: [`chatSessionsRepository.sql.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/apps/mobile/infra/repositories/sql/chatSessionsRepository.sql.ts)
...
Source: [`chatMessageRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/chatMessageRepository.ts) · Implementation: [`chatMessagesRepository.sql.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/apps/mobile/infra/repositories/sql/chatMessagesRepository.sql.ts)
...
Source: [`proactiveStateRepository.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/proactiveStateRepository.ts) · Implementation: [`proactiveStateRepository.sql.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/apps/mobile/infra/repositories/sql/proactiveStateRepository.sql.ts)
...
Source: [`unitOfWork.ts`](https://github.com/akdasa-studios/lectorium/blob/main/modules/libs/domain/ports/unitOfWork.ts) · Implementation: `modules/apps/mobile/infra/repositories/sql/unitOfWork.sql.ts`

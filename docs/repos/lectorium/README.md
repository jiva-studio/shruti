...
<p align="center"><i>
Lectorium is your personal lecture companion — listen to lectures, follow along with synced transcripts, save what matters, and ask an AI assistant about anything you hear. Whether you're commuting, walking, or relaxing at home, Lectorium makes learning accessible on the go.
</i></p>
...
└── tools/
    └── lectorium-mcp/          # Go MCP service that owns the catalog SQLite and publishes it to S3
...
| Service | Purpose |
| --- | --- |
| [Qase](https://app.qase.io/project/LECTORIUM) | Test management & release runs |
| [Sentry](https://akdasa-studio.sentry.io/issues/?project=4511584811220992) | Error & crash tracking |
| [Langfuse](https://langfuse.obs.eu.lectorium.jiva.studio/) | LLM/chat observability & prompt management |
| [Grafana](https://grafana.obs.eu.lectorium.jiva.studio/) | Metrics & infrastructure dashboards |
...
- **Runbooks**
  ...
  - [lectorium-mcp](runbooks/lectorium-mcp.md) — catalog MCP daemon, pipeline stages, publishing.
